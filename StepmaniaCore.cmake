...
if(CMAKE_SYSTEM_NAME MATCHES "tvOS")
  set(TVOS TRUE)
  set(MACOSX FALSE)
else()
  set(TVOS FALSE)
...
elseif(TVOS)
  ...
  set(WITH_CRASH_HANDLER FALSE)

  find_library(MAC_FRAME_ACCELERATE Accelerate ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_AUDIOTOOLBOX AudioToolbox ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_AVFAUDIO AVFAudio ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_COREAUDIO CoreAudio ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_COREFOUNDATION CoreFoundation ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_FOUNDATION Foundation ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_UIKIT UIKit ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_METAL Metal ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_METALKIT MetalKit ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_GAMECONTROLLER GameController ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_OPENGLES OpenGLES ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_GLKIT GLKit ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_COREGRAPHICS CoreGraphics ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_QUARTZCORE QuartzCore ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_SYSTEM System ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_CFNETWORK CFNetwork ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_UNIFORMTYPEIDENTIFIERS UniformTypeIdentifiers ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  find_library(MAC_FRAME_MOBILECORESERVICES MobileCoreServices ${CMAKE_SYSTEM_FRAMEWORK_PATH} REQUIRED)
  ...
  mark_as_advanced(MAC_FRAME_ACCELERATE
                   ...
                   MAC_FRAME_METAL
                   MAC_FRAME_METALKIT
                   MAC_FRAME_GAMECONTROLLER
                   MAC_FRAME_OPENGLES
                   MAC_FRAME_GLKIT
                   MAC_FRAME_COREGRAPHICS
                   MAC_FRAME_QUARTZCORE
                   MAC_FRAME_SYSTEM
                   MAC_FRAME_CFNETWORK
                   MAC_FRAME_UNIFORMTYPEIDENTIFIERS
                   MAC_FRAME_MOBILECORESERVICES)
